...
# Usage: ./scripts_evolve/${MODEL_NAME}/general_debug.sh WANDB_PROJECT RUN_NAME INITIAL_PROGRAM EVALUATOR_FILE CONFIG_YAML SAVE_PATH IS_TRAINING LAZY_OUTPUT_PENALTY REWARD_PROCESS_TYPE SEED
